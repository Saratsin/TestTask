...
Відповідь:
Якщо ми потім хочемо відписати даний метод від події, то не матимемо можливості для цього, оскільки не знаємо посилання на цей анонімний метод. Наприклад:  
